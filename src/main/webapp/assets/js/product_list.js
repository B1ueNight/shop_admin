...
$(function () {
    $("#root_cate").change(function () {
        let seq = $(this).val();
        $("#samll_cate").html('option value="0">소분류 선택</option>');
    ...
    $("#save").click(function () {
        ...
        let data = {
            ...
            p_img_list: arrImage,
            p_desc: {
                pdd_content: $("#product_description").val()
            },
    ...
    $(".detail").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                console.log(data.p_desc_img_list);
    ...
    $(".popup .btns #cancel").click(function () {
        ...
        $("#mid_cate").html('<option value="0">중분류 선택</option>');
        $("#small_cate").html('<option value="0">소분류 선택</option>');
        $("#mid_cate").val(0).prop("disabled", true);
        $("#small_cate").val(0).prop("disabled", true);
...
function onClickImageDelete(index, target, file) {
    $.ajax({
