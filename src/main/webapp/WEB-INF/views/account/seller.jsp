    ...
    <main>
                ...
                <tbody>
                    <c:forEach items="${list}" var="item">
                        <tr>
                            ...
                            <td>
                                <button class="modify" data-seq="${item.si_seq}"><i class="fas fa-edit"></i></button>
                                <button class="delete" data-seq="${item.si_seq}"><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div class="popup_wrap">
            <div class="popup">
                ...
                <input type="text" id="si_name" placeholder="판매자 명">
            ...
            <div class="seller_additional_info">
                ...
                <input type="text" id="si_phone" placeholder="연락처">
