    ...
    <main>
                    ...
                    <c:forEach items="${list}" var="item">
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${item.mi_gen == 3}"><span>여성</span></c:if>
                            </td>
                            <td>${item.mi_address}</td>
                            <td>${item.mi_phone}</td>
                            <td>
                                <c:if test="${item.mi_grade == 1}"><span class="grade gd1">신규</span></c:if>
                                <c:if test="${item.mi_grade == 2}"><span class="grade gd2">일반</span></c:if>
                                <c:if test="${item.mi_grade == 3}"><span class="grade gd3">우수</span></c:if>
                                <c:if test="${item.mi_grade == 4}"><span class="grade gd4">VIP</span></c:if>
                                <c:if test="${item.mi_grade == 5}"><span class="grade gd5">VVIP</span></c:if>
                            </td>
                            <td>
        ...
        <div class="popup_wrap">
            <div class="popup">
                ...
                <input type="text" id="mi_phone" placeholder="연락처">
                <select id="mi_gen">
