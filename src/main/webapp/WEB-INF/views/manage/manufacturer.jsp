...
<body>
    <main>
        <h1>제조사 관리</h1>
        <div class="manufactuer_summary summary_area">
            <h2> 총 ${cnt} 제조사</h2>
        ...
        <div class="manufacturer_popup_wrap popup_wrap">
            <div class="manufacturer_popup popup">
                ...
                <input type="text" id="mfi_name" placeholder="제조사 명"></td>
                <input type="text" id="mfi_phone" placeholder="전화번호"></td>
                <input type="text" id="mfi_email" placeholder="이메일"></td>
                <div class="buttons">
